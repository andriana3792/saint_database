...
urlpatterns = [
    path('', SaintListView.as_view(), name='saint-list'),  # root path shows list of saints
    path('saints/', SaintListView.as_view(), name='saint-list-alt'),  # optional alternative URL
