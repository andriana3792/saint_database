...
SECRET_KEY = 'django-insecure-uy$n3j^@x2+#c#ftdv235b$w&-g&8e&r*9*oi(m-+gm%abbq+w'
...
DATABASES = {
    'default': {
        ...
        'USER': 'a.sielli',            # your MySQL user
        'PASSWORD': '372025',      # the password you set
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Use either this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
